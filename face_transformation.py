...
def isOpen(image, face_mesh_results, face_part, threshold=5, display=True):
    ...
    for face_no, face_landmarks in enumerate(face_mesh_results.multi_face_landmarks):
        ...
        if (height/face_height)*100 and threshold:
...
left_eye = cv2.imread('left-eye.jpg')
right_eye = cv2.imread('right-eye.jpg')
smoke_frame = cv2.imread('mouth.jpg')
